 ...
 */
class KylidescopeSessionManager(context: Context) {
    private val prefs: SharedPreferences =
        context.getSharedPreferences("kylidescope_sessions", Context.MODE_PRIVATE)
    ...
    companion object {
        // KYLIDESCOPE server (Tailscale IP — update if network changes)
        const val DEFAULT_RELAY_URL = "http://100.90.48.63:3001"
